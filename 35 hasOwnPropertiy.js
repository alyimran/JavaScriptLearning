...
CreateFunction.prototype.showEmail= function(){
        ...
        // As we can see that this array does not have none of those fucntions
        // Plus , we said earlier that only a function has [[prototype]]
        //but we can see above that the out put of array also has prototypes
       ...
       // Please notice that the prototype is an array in case of array(Maker of javascript thought that it would be great to make it array)
